...
def augment(img_data, config, augment=False, mode="train"):
    ...
    while True:
        ...
        for img_data in all_img_data:
            try:
                ...
                img_data_aug, x_img = augment(img_data, C, augment=False, mode=mode)
                ...
                x_img = x_img.reshape((resized_width, resized_height, 1))
                ...
                #x_img = x_img[:,:, (2, 1, 0)]  # BGR -> RGB Not needed
...
def rpn_loss_regr(num_anchors):
    ...
    def rpn_loss_regr_fixed_num(y_true, y_pred):
        y_true = K.cast(y_true, 'float32') # TODO move cast to data loading phase
...
def class_loss_regr(num_classes):
    ...
    def class_loss_regr_fixed_num(y_true, y_pred):
        y_true = K.cast(y_true, 'float32')
        x = y_true[:, :, 4*num_classes:] - y_pred # TODO added cast 
        x_abs = K.abs(x)
